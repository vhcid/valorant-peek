...
import {
  fetch, parseSetCookie, stringifyCookies, extractTokensFromUri, tokenExpiry,
} from '../misc/util.js';
...
export const redeemUsernamePassword = async (id, login, password) => {
  ...
  if (json2.type === 'response') {
    ...
    saveUserData();
    return {
      success: false, mfa: true, method: json2.multifactor.method, email: json2.multifactor.email,
    };
  }
